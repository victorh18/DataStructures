...
namespace DataStructures
{
    class Program
    {
        ...
        public static void TestingDoubleLinkedLists(){
            ...
            PrintingDoubleListsFoward(dl.head);
            PrintingDoubleListsBackwards(dl.GetLast());
        }
        ...
        public static void PrintingDoubleListsFoward(DNode<int> _n){
            Console.WriteLine(_n.obj);
            if(_n.NextNode != null){
                PrintingDoubleListsFoward(_n.NextNode);
            }
        }
        public static void PrintingDoubleListsBackwards(DNode<int> _n){
            Console.WriteLine(_n.obj);
            if(_n.PreviousNode != null){
                PrintingDoubleListsBackwards(_n.PreviousNode);
            }
        }
    }
